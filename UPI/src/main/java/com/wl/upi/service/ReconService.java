...
import com.wl.upi.dao.ReconDao;
...
public class ReconService
{
  ...
  public String generateFile(String bankCode, String jobParm)
    throws Exception
  {
    ...
    List<FileDataDTO> dataList = this.reconDao.getFileData(bankCode, fromDate, toDate);
  ...
  private boolean SFTPFileUpload(String fileName, String localpath, String bankCode)
  {
    ...
    if (ReconUtils.uploadFileToServer(new String[] { fileName, localpath, sftpPath, sftpHost, sftpuserName, sftpPass, sftpPort }))
    {
  ...
  private boolean createPNBCsvFile(List<FileDataDTO> fildeDto, String filepath, String ddMMyy)
  {
    ...
    try
    {
      ...
      sb.append("FT" + String.format("%09d", new Object[] { Integer.valueOf(fildeDto.size()) }));
