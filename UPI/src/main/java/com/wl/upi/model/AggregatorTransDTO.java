 ...
 * @author ritesh.patil
 * 
 * Mapping class field with database columns 
 * 
 * BharaQR case  
 ...
 * 
 * mid           merchant_id
 * mpan          mvisa_merchant_id
 * custName      customer_name
 * txnCurr        currency_code
 * txnAmt         amount
 * authCode       auth_code
 * refNo          ref_no
 ...
 * bankCode       bank_code
 * aggrId         will come from request as fromEntity
 * consumerPan    customer_pan
 * 
 * UPI case
...
public class AggregatorTransDTO {
	...
	public String toString() {
		return "AggregatorTransDTO [mid=" + mid + ", mpan=" + mpan + ", custName=" + custName + ", txnCurr=" + txnCurr
				...
				+ consumerPan + ", merchantVpa=" + merchantVpa + ", customerVpa=" + customerVpa + "]";
	}
