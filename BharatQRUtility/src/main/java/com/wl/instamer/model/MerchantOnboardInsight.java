...
public class MerchantOnboardInsight {

	@JsonProperty(value="MerIden")
	private Integer merIdentification;
	@JsonProperty(value="BankCode")
	private String bankCode;
	@JsonProperty(value="Mercreationdate")
	private String merCreationDate;
	@JsonProperty(value="AppNumber")
	private Long appNo;
	@JsonProperty(value="Mercustid")
	private String customerId;
	@JsonProperty(value="Mertype")
	private String merType;
	@JsonProperty(value="Mersegment")
	private String merSegment;
	@JsonProperty(value="Mcc")
	private Integer mcc;
	@JsonProperty(value="Tcc")
	private Integer tcc;
	@JsonProperty(value="Pan")
	private Long panNo;
	@JsonProperty(value="Melegalname")
	private String legalName;
	@JsonProperty(value="Medbaname")
	private String dbaName;
	@JsonProperty(value="Zonecode")
	private Integer zoneCode;
	@JsonProperty(value="Branchcode")
	private Integer branchCode;
	@JsonProperty(value="Grossmdrtype")
	private String grossMdrType;
	@JsonProperty(value="Merdob")
	private String dob;
	@JsonProperty(value="Merbusentity")
	private String businessEntity;
	@JsonProperty(value="IACPerson")
	private String instAddContactPerson;
	@JsonProperty(value="IAAdd1")
	private String instAddressLine1;
	@JsonProperty(value="IAAdd2")
	private String instAddressLine2;
	@JsonProperty(value="IACITY")
	private Integer instCity;
	@JsonProperty(value="IASTATE")
	private Integer instState;
	@JsonProperty(value="IADistrict")
	private Integer instAddDistrict;
	@JsonProperty(value="IALOCATION")
	private Integer instLocation;
	@JsonProperty(value="IAPincode")
	private Integer instAddPincode;
	@JsonProperty(value="IATelephone")
	private Long instAddTelephone;
	@JsonProperty(value="IAMobileno")
	private Long instAddMobileNo;
	@JsonProperty(value="IAEmail1")
	private String instAddEmail;
	@JsonProperty(value="RAAdd1")
	private String raAddressLine1;
	@JsonProperty(value="RAAdd2")
	private String raAddressLine2;
	@JsonProperty(value="RAPincode")
	private Integer raPinCode;
	@JsonProperty(value="RAState")
	private Integer raState;
	@JsonProperty(value="RADistrict")
	private Integer raDistrict;
	@JsonProperty(value="RACity")
	private Integer raCity;
	@JsonProperty(value="RAMobileone")
	private Long raMobile1;
	@JsonProperty(value="RAMobiletwo")
	private Long raMobile2;
	@JsonProperty(value="Paymentby")
	private String paymentBy;
	@JsonProperty(value="Accno")
	private Long accountNo;
	@JsonProperty(value="Acclabel")
	private String accountLabel;
	@JsonProperty(value="Beifsccode")
	private String bnfIfsc;
	@JsonProperty(value="Beaccname")
	private String bnfName;
	@JsonProperty(value="Beaccnumber")
	private String bnfAccountNo;
	@JsonProperty(value="Bebankname")
	private String bnfBankName;
	@JsonProperty(value="Paysoldid")
	private Integer paySoldId;
	@JsonProperty(value="StmtReqtype")
	private String stmtReqType;
	@JsonProperty(value="Stmtfrq")
	private String stmtFrequency;
	@JsonProperty(value="Merdocname")
	private String merDocumentName;
	@JsonProperty(value="TerminalType")
	private String terminalType;
	@JsonProperty(value="Edcmodel")
	private String edcModel;
	@JsonProperty(value="domupto1000onus")
	private Double domUpto1000Onus;
	@JsonProperty(value="domupto1000offus")
	private Double domUpto1000Offus;
	@JsonProperty(value="Domoffusless2000")
	private Double domOffusLess2000;
	@JsonProperty(value="Domonusless2000")
	private Double domOnusLess2000;
	@JsonProperty(value="Domoffusgret2000")
	private Double domOffusGret2000;
	@JsonProperty(value="Domonusgret2000")
	private Double domOnusGret2000;
	@JsonProperty(value="BankSubRate")
	private Integer bankSubRate;
	@JsonProperty(value="LeadgenId")
	private Integer leadGenId;
	@JsonProperty(value="Secode")
	private String seCode;
	@JsonProperty(value="Approvedby")
	private String approvedBy;
	@JsonProperty(value="ProfitabilityStatus")
	private String profitabilityStatus;
	@JsonProperty(value="Postfacto")
	private String postFacto;
	@JsonProperty(value="Nonopecano")
	private String nonOperCANo;
	@JsonProperty(value="Riskapp")
	private String riskApproval;
	@JsonProperty(value="Tipflag")
	private String tipFlag;
	@JsonProperty(value="Convfees")
	private String conFeeFlag;
	@JsonProperty(value="Convfeesamt")
	private Double conFeeAmount;
	@JsonProperty(value="Convfeesamtper")
	private Integer conFeePercentage;
	@JsonProperty(value="MerchatMobileNumber")
	private Long merMobileNumber;
	@JsonProperty(value="Merchantemailid")
	private String merEmailId;
	@JsonProperty(value="ReferralCode")
	private String referralCode;
	@JsonProperty(value="NoOfTerminal")
	private Integer numberOfTerminal;
	@JsonProperty(value="Joiningfee")
	private Integer joiningFee;
	@JsonProperty(value="Rentalfee")
	private Integer rentalFee;
	@JsonProperty(value="Setupfee")
	private Integer setupFee;
	@JsonProperty(value="Othercharges")
	private Integer otherCharges;
	@JsonProperty(value="IdenType")
	private String identificationType;
	@JsonProperty(value="Refund")
	private String isRefundAllowed;
	@JsonProperty(value="p_InstallationAddressFlag")
	private String pInstallationAddFlag;
	@JsonProperty(value="Creditcardpremium")
	private Integer creditCardPremium;
	@JsonProperty(value="Creditcardnonpremium")
